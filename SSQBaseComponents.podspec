...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SSQBaseComponents.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Malte Schoppe/SSQBaseComponents'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Malte Schoppe' => 'mse@spacesquad.de' }
  s.source           = { :git => 'https://github.com/Malte Schoppe/SSQBaseComponents.git', :tag => s.version.to_s }
